...
public class studentlogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<form action=studentcheckpwd method=post>");
   ...
   //     out.println("          <li class='mega-menu'> <a class='level-top' href='AboutUs.jsp'><span>About Us</span></a> </li>");
        ...
        out.println("            </div>");
        out.println("          </div>");
        out.println("          <div class='col-2 registered-users'><strong>Student Login</strong>");
        out.println("<div>");
        out.println("            <div class='content'>");
        out.println("              <ul class='form-list'>");
        out.println("                <li>");
        out.println("                  <label for=''>Enrollment No: <span class='required'>*</span></label>");
        out.println("                  <input type='text' name=enrollmentno class='input-text required-entry'>");
        out.println("                </li>");
        out.println("                <li>");
        out.println("                  <label for=''>Password <span class='required'>*</span></label>");
        out.println("                  <input type='password' name=password class='input-text required-entry validate-password'>");
        out.println("                </li>");
        out.println("              </ul>");
